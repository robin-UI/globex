...
function GoldenVisa() {
  return (
    <main className="pt-24 md:pt-32 ">
      ...
      <section className="flex justify-between flex-col md:flex-row md:items-center mb-8 gap-5 lg:gap-8 px-3 lg:px-16">
      ...
      <section className="text-white bg-gradient-to-r from-[#2BDEFA] to-[#377CFF] px-3 lg:px-16 lg:py-10">
        ...
        <div className="flex flex-col gap-3">
          <p className="text-lg lg:text-xl text-center font-semibold">
            ...
            efforts to foster economic growth and innovation, offering long-term
            residency to investors, entrepreneurs, professionals, and students.
            With over 45,000 recipients, the Golden Visa program has
            successfully cultivated a thriving community of individuals who
            contribute to the nation’s dynamic landscape
          </p>
          <p className="text-lg lg:text-xl text-center font-semibold">
            Eligibility for the Dubai Golden Visa is determined by relevant
            government agencies and tailored to meet diverse needs. Whether you
            aspire to launch a business, excel in your profession, or pursue
            advanced studies, the Golden Visa provides a streamlined pathway to
            achieving your goals in the UAE
          </p>
          <p className="text-lg lg:text-xl text-center font-semibold">
          ...
          <p className="text-lg lg:text-xl text-center font-semibold">
            By securing a Dubai Golden Visa, individuals not only open doors to
            personal and professional growth but also contribute to the UAE’s
            vibrant and prosperous society. This visa program is more than just
            a residency option; it’s an invitation to become a part of a
            forward-thinking community that values innovation and excellence.
          </p>
        </div>
      </section>
      ...
      <section className="my-5 px-3 lg:px-16 lg:py-10">
        ...
        <p className="text-lg lg:text-2xl text-center lg:mb-10">
          Delve into a world of benefits and open the door to a prosperous
          future with the UAE’s Golden Visa program. Here are five key reasons
          why the Golden Visa is an excellent choice for your residency.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-8 mt-2">
          <div>
          ...
          <div>
            ...
            <p className="text-lg lg:text-xl">
              Take advantage of the UAE’s booming business landscape, with ample
              opportunities for investment across various sectors. Whether
              you’re looking to start or expand your business, the Golden Visa
              offers the perfect platform, supported by the country’s
              investor-friendly environment and strategic location
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg lg:text-xl">
              ...
              with quality learning experiences that nurture both their academic
              and personal growth.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg lg:text-xl">
              ...
              growth. Invest in their future with confidence, knowing that they
              have access to quality educational opportunities within the UAE.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg lg:text-xl">
              ...
              endless options for entertainment and leisure to suit all tastes.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg lg:text-xl">
              Benefit from a favourable tax regime, with no personal income tax,
              corporate tax, or capital gains tax on certain investments. The
              Golden Visa allows you to maximise your financial returns, keeping
              more of your hard-earned income and enhancing your overall
              financial security.
            </p>
          </div>
        </div>
      ...
      <section className="relative py-14 px-3 lg:px-16 bg-[#F8F8F8] ">
        ...
        <p className="text-lg lg:text-2xl text-center lg:mb-10">
          ...
          with the prestigious Dubai Golden Visa. Designed to attract and retain
          top talent from around the world, the Golden Visa offers unparalleled
          opportunities for investors, entrepreneurs, professionals, and
          students. Here are the requirements to obtain the coveted Dubai Golden
          Visa:
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-8 my-3">
      ...
      <section className="flex flex-col gap-3 py-3 lg:py-14 lg:px-16 ">
        ...
        <p className="lg:text-lg">
          Start your Golden Visa journey today with our expert team guiding you
          through the application process. We ensure a smooth and seamless
          ...
          Contact us now to learn more about the Dubai Golden Visa and take the
