      ...
      <div className="container mx-auto px-4 py-16 md:px-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <button onClick={handleModal} className="bg-blue-600 px-8 py-3 hover:bg-blue-700 bg-[linear-gradient(270deg,#2BDEFA_0%,#377CFF_100%)] text-white font-semibold rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
              Contact Us
            </button>
          </div>
