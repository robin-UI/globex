          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="col-span-2">
              <div className="text-center lg:text-left mb-10 sm:mb-16">
                <p className="text-gray-600 text-base sm:text-lg max-w-3xl uppercase mb-3">
                  what do we offer
                </p>
  ...
  return (
    <>
      <div
        ...
        className="h-full rounded-xl p-6 sm:p-8 lg:p-12 relative"
      >
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 text-white max-w-6xl mx-auto">
          <div className="text-center sm:text-left">
            <h2 className="text-left text-xl sm:text-3xl lg:text-5xl leading-[62px] font-bold mb-2">
              Get visa with <br /> 100% Success Rate
            </h2>
        ...
        <div className="absolute top-[14px] left-[14px]">
          ...
          >
            <path
              opacity={0.2}
              d="M398.708 166.538L915.786.521l70.747 220.35L65.745 516.506-21.92 243.463 502.876 74.968c7.349-2.36 15.219 1.685 17.578 9.034 2.36 7.35-1.685 15.22-9.034 17.579l-121.086 38.876c-7.202 2.313-11.165 10.025-8.853 17.227 2.312 7.202 10.025 11.166 17.227 8.854z"
              fill="#fff"
            />
          </svg>
        </div>
  ...
  return (
    ...
    >
      ...
      <img
        ...
        src="./images/homepage/employeLogo.svg"
        alt=""
      />
