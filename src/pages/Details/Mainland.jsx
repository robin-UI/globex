...
function Mainland() {
  ...
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title>UAE Mainland Company Formation | Dubai Business Setup</title>
        <meta
          name="description"
          content="Looking to form a mainland company in the UAE? We specialize in UAE
mainland company formation, with a focus on Dubai. Get expert
guidance and support throughout the setup process. "
        />
      </Helmet>
        ...
        <div className="relative container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Our elite team of legal experts, financial advisors, and business
              consultants excel in facilitating diverse business establishments
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-2xl group hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our proven track record includes assisting countless
                    entrepreneurs globally in securing business licenses,
                    establishing physical presence, and building prosperous
                    ventures in the UAE.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl group hover:shadow-xl transition-all duration-300 border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mr-3 font-bold">
                    1
                  </span>
