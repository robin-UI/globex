          ...
          <div className="logo-sec ">
            <div className="flex justify-between items-center px-6 lg:px-0">
              ...
              <button
                ...
                className="text-base text-blue-400 bg-white px-9 h-10 rounded-3xl lg:hidden "
              >
                Get a Quote
              </button>
            </div>
          ...
          <div className="footer-contactus px-2 ">
            ...
            <div className="location flex lg:justify-start items-center pt-5">
              ...
              Dubai, United Arab Emirates */}
                {/* GLOBEX INCORPORATION BUSINESS SERVICES L.L.C */}
                Burjuman Business Tower Sheikh Khalifa Bin Zayed St, Al Mankhool
                Dubai , United Arab Emirates
              </p>
            </div>
            ...
            <div className="email flex lg:justify-start items-center pt-2">
              <img
                ...
                alt=""
              />
              <p className="text-white pl-3">contact@globexincorporation.com</p>
            </div>
            <button
              onClick={() => setOpen(true)}
              className="text-blue-700 rounded-full mt-4 bg-white w-[160px] h-[50px] mx-auto lg:mx-0"
            >
              Get a Quote
            </button>
          </div>
